<template>
  <v-container class="fill-height d-flex justify-center align-center bg-dark-theme">
    <div class="text-center">
      <v-icon color="green-lighten-2" size="80" class="mb-4">mdi-soccer</v-icon>
      <h1 class="text-h3 font-weight-bold text-white mb-2">Panel de Jugador</h1>
      <p class="text-h6 text-grey-lighten-1">ESTE ES EL PANEL DE USUARIO (JUGADOR)</p>
