...
.bg-glass-container {
  background: rgba(0, 0, 0, 0.3); /* Base oscura del menú */
...
.active-drop {
  /* 1. Fondo PRÁCTICAMENTE TRANSPARENTE (solo un 5% de blanco arriba para el reflejo) */
  ...
  /* 2. Filtro Blur para distorsionar ligeramente lo de atrás */
  backdrop-filter: blur(5px);
  
  color: white !important;
  
  /* 3. SOMBRAS Y BORDES que definen la forma sin usar color de relleno */
  box-shadow: 
    inset 0 1px 1px rgba(255, 255, 255, 0.4), /* Brillo fino superior (reflejo de luz) */
    inset 0 -1px 2px rgba(0, 0, 0, 0.2),      /* Sombra interna abajo para profundidad */
    0 4px 10px rgba(0, 0, 0, 0.15);           /* Sombra externa suave */
